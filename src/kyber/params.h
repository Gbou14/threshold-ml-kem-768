...
/* Full CCA-secure ML-KEM (the Fujisaki-Okamoto-transformed KEM built on
 * top of the IND-CPA PKE above), per FIPS 203. */
#define KYBER_SSBYTES 32 /* shared-secret size */
#define KYBER_PUBLICKEYBYTES KYBER_INDCPA_PUBLICKEYBYTES
#define KYBER_CIPHERTEXTBYTES KYBER_INDCPA_BYTES
/* dk = dkPKE || ek || H(ek) || z */
#define KYBER_SECRETKEYBYTES (KYBER_INDCPA_SECRETKEYBYTES + KYBER_PUBLICKEYBYTES + 2 * KYBER_SYMBYTES)
